...
</style></head><body><main class="wrap"><nav class="nav"><a href="/">INVESTORS.GE</a><a href="/markets.html">← ბაზრები</a></nav>
...
${historyTable(company.financialHistory?.annual, "წლიური ფინანსური ისტორია")}${historyTable(company.financialHistory?.quarterly, "კვარტალური ფინანსური ისტორია")}
